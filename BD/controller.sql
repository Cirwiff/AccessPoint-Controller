...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25-Ago-2021 às 13:20
...
CREATE TABLE `accesspoint` (
  ...
  `same_network` varchar(30) NOT NULL,
  ...
  `wpa2_server` varchar(150) NOT NULL,
...
CREATE TABLE `apgroups` (
  ...
  `ssid` varchar(30) DEFAULT NULL,
  `type_password` varchar(30) NOT NULL,
  `password` varchar(30) DEFAULT NULL,
  `wpa2_server` varchar(150) NOT NULL,
  `channel_mode` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
